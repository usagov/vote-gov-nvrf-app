...
const DataProvider = ({ children }) => {
  ...
  const stateContent = useFetchData(
    `${locale}/nvrf/assets/state/${currentStateId}/data.json`,
    "",
    true,
  );
  const stringContent = useFetchData(
    `${locale}/nvrf/assets/strings.json`,
    "6f8bb721-f017-4fcc-a826-dfc93c6759b7",
  );
