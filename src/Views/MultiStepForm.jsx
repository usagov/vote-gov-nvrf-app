...
function MultiStepForm(props) {
  ...
  const mainContent = pageContent.data.find(
    (item) => item.uuid === "2c597df4-53b6-4ef5-8301-7817b04e1099",
  );
  ...
  return (
    <>
      ...
      <ProgressBar
        step={step}
        steps={stepContent}
        handleGoBack={handleGoBackSteps}
        setStep={setStep}
      />
      <div className={"margin-top-8 maxw-tablet margin-x-auto"}>
        {step < 5 && (
          <>
            <h1>
              {mainContentTitle.replace("@state_name", stateContent.data.name)}
            </h1>
        ...
        >
          {step === 1 && (
            <PersonalInfo
              ...
              step={stringContent.data.step.find(
                (item) => item.step_id === "personal",
              )}
            />
          )}
          {step === 2 && (
          ...
          {step === 3 && (
            <Identification
              ...
              fieldContent={fieldContent.data}
              step={stringContent.data.step.find(
                (item) => item.step_id === "identification",
              )}
            />
          )}
          {step === 4 && (
